...
import diao.taotao.service.ItemParamItemService;
@Service
public class ItemParamItemServiceImpl implements ItemParamItemService {
    @Autowired
    TbItemParamItemMapper itemParamItemMapper;
    @Override
    public String getItemParamByItemId(Long itemId) {//些方法与ItemParamService中的getItemParamByItemId()方法完全一致
        // 根据商品id查询规格参数
        ...
        // 生成html
        // 把规格参数json数据转换成java对象,可从现成的网上的商城类似的页面上拷贝一个元素源码下来，以样修改
