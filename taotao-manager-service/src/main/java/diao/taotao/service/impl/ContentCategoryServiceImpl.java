...
import diao.taotao.mapper.TbContentCategoryMapper;
import diao.taotao.pojo.TbContentCategory;
import diao.taotao.pojo.TbContentCategoryExample;
import diao.taotao.pojo.TbContentCategoryExample.Criteria;
...
public class ContentCategoryServiceImpl implements ContentCategoryService {
    ...
    public TaotaoResult deleteContentCategory(long parentId, long id) {
        if(parentId==0){
            TbContentCategory sunNode = contentCategoryMapper.selectByPrimaryKey(id);
            parentId=sunNode.getParentId();
        }
        int affectRows = contentCategoryMapper.deleteByPrimaryKey(id);
    ...
    public TaotaoResult updateContentCategory(long id, String name) {
        ...
        category.setId(id);
        if (contentCategoryMapper.updateByPrimaryKeySelective(category) >= 1) {
            return TaotaoResult.ok();
        } else {
            return null;
        }
